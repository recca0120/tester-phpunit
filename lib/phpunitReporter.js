...
function parseXML(xml :string) :Promise<string> {
...
function replaceFirst(str :string, search :string) :string {
...
export async function JunitParser(junitXML :string) :Array<Object> {
